...
import com.dwb.appbardemo.model.LyricModel;
...
public class LoveMusic extends AppCompatActivity implements View.OnClickListener {

    public final static String TAG = "OnlineMusicActivity";

    MyImageView iv_icon;
    ImageView nextIv, playIv, lastIv, playStyle, love_music,iv_back_love;
    ...
    //存放播放模式的图标
    int[] imgs_playStyle = new int[]{R.drawable.ly_playbylist, R.drawable.ly_playonlyone, R.drawable.ly_random};
    ...
    public static final String NETF_CLOSED = "NETF_CLOSED";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //设置两个隐藏
        inc_online.setVisibility(View.GONE);
    ...
    class LrcTask extends TimerTask {
        ...
        public void run() {
            ...
            LoveMusic.this.runOnUiThread(new Runnable() {
                public void run() {
                    //滚动歌词
    ...
    private void initView() {
        ...
        iv_back_love = findViewById(R.id.iv_back);
        ...
        iv_back_love.setOnClickListener(this);
        iv_icon.stopImg();
        ...
        switch (v.getId()) {
            ...
            case R.id.local_music_bottom_iv_last:
                if (mDatas.size() != 0){
                    ...
                    Toast.makeText(this, "音乐数据为空，请返回添加", Toast.LENGTH_SHORT).show();
                }
...
//      public static final int NOTIFICATION_ID = 10003;
    ...
    private class MyBroadCastReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            final Notification_Controller notificationController = new Notification_Controller(LoveMusic.this);
            notificationController.showNotification();

            if (intent.getAction() == NETF_CLOSED) {
    ...
    private void wakeNotification() {
        ...
        intentFilter.addAction(NETF_CLOSED);
    ...
    private void findLoveMusic() {
        mDatas = new ArrayList<>();
        BmobQuery<OnlineMusicBean> bmobQuery = new BmobQuery<>();
        bmobQuery.addWhereEqualTo("love", true);
        bmobQuery.findObjects(new FindListener<OnlineMusicBean>() {
            @Override
            public void done(List<OnlineMusicBean> list, BmobException e) {
                if (e == null) {
                    for (int i = 0; i < list.size(); i++) {
                        ...
                        Intent intent = new Intent();
                        intent.setAction("LoveMusic");
                        intent.putExtra("LoveMusicListSize",mDatas.size());
                    ...
                    //创建适配器对象
                    adapter = new OnlineMusicAdapter(LoveMusic.this, mDatas);
                    musicRv.setAdapter(adapter);
                    //设置布局管理器
                    LinearLayoutManager layoutManager = new LinearLayoutManager(LoveMusic.this, LinearLayoutManager.VERTICAL, false);
