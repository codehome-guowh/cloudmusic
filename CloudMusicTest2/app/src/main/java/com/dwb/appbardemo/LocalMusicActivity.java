...
import com.dwb.appbardemo.adapter.LocalMusicAdapter;
...
public class LocalMusicActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public final static String TAG = "LocalMusicActivity";
    MyImageView iv_icon;
    ImageView nextIv, playIv, lastIv, playStyle, iv_back;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //创建空集合，通过工具类往集合中添加数据源
        mDatas = new ArrayList<>();
        mDatas = MusicDataUtils.ResolveMusicToList(LocalMusicActivity.this);
    ...
    class LrcTask extends TimerTask {
        ...
        public void run() {
            ...
            LocalMusicActivity.this.runOnUiThread(new Runnable() {
                public void run() {
                    //滚动歌词
    ...
    private void sendMessageToMainActivity(LocalMusicBean musicBean) {
        ...
        intent1.putExtra("albumPicUrl", musicBean.getAlbumPic());
        intent1.putExtra("duration",musicBean.getDuration());
    ...
    private class MyBroadCastReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            final NotificationController notificationController = new NotificationController(LocalMusicActivity.this);
